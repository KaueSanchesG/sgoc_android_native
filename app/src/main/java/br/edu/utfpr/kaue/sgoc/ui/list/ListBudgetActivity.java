...
public class ListBudgetActivity extends AppCompatActivity {
    ...
    private MenuItem menuBudgetSorting;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        BottomNavListener.setup(this, bottomNav, R.id.budget);
    }

    @Override
    public boolean onCreateOptionsMenu(Menu menu) {
        getMenuInflater().inflate(R.menu.opc_budget, menu);

        menuBudgetSorting = menu.findItem(R.id.menuBudgetSort);
    ...
    public boolean onOptionsItemSelected(@NonNull MenuItem item) {
        ...
        if (idMenuItem == R.id.menuBudgetAdd) {
            //openNewItem();
            return true;
        } else if (idMenuItem == R.id.menuAbout) {
            openAbout();
            return true;
        } else if (idMenuItem == R.id.menuBudgetSort) {
    ...
    private void updateSortingIcon() {
        if (ascSort) {
            menuBudgetSorting.setIcon(R.drawable.ic_action_ascending);
        } else {
            menuBudgetSorting.setIcon(R.drawable.ic_action_descending);
        }
    }
